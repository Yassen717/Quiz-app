      ...
      <div class="results-container">
        <div class="results-header">
          ...
          <div class="score-display">
            <div class="score-circle" style={`--score-color: ${getPerformanceColor()}`}>
        ...
        <div class="action-buttons">
          <button class="action-button primary" onClick$={onRestart}>
            🔄 Play Again
          </button>
          <button class="action-button secondary" onClick$={onBackToCategories}>
            🏠 Back to Categories
          </button>
        </div>
