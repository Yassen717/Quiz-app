        ...
        <h1 class="settings-title" id="settings-title">
          <span class="settings-icon" aria-hidden="true">
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              <path d="M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M19.4 15a1 1 0 0 0 .2 1.1l.1.1a2 2 0 0 1-2.8 2.8l-.1-.1a1 1 0 0 0-1.1-.2c-.7.3-1.4.5-2.2.6a1 1 0 0 0-.9.9v.2a2 2 0 1 1-4 0v-.2a1 1 0 0 0-.9-.9c-.8-.1-1.5-.3-2.2-.6a1 1 0 0 0-1.1.2l-.1.1A2 2 0 1 1 3.3 16l.1-.1a1 1 0 0 0 .2-1.1 9.2 9.2 0 0 1 0-2.2 1 1 0 0 0-.2-1.1l-.1-.1a2 2 0 0 1 2.8-2.8l.1.1a1 1 0 0 0 1.1.2c.7-.3 1.4-.5 2.2-.6a1 1 0 0 0 .9-.9V4a2 2 0 1 1 4 0v.2a1 1 0 0 0 .9.9c.8.1 1.5.3 2.2.6a1 1 0 0 0 1.1-.2l.1-.1A2 2 0 0 1 21 8.2l-.1.1a1 1 0 0 0-.2 1.1c.1.7.2 1.5.2 2.2s-.1 1.5-.2 2.2Z" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </span>
          Settings
        </h1>
      ...
      <div class="settings-content">
        <div class="settings-grid">
          <section class="card card--half" aria-labelledby="appearance-title">
            ...
            <div class="row" role="group" aria-label="Theme">
              <div class="label">
                ...
                <span class="desc">Switch between light, dark, or follow your system setting.</span>
              </div>
              <ThemeToggle />
            </div>
          </section>
          ...
          <section class="card card--half" aria-labelledby="behavior-title">
            ...
            <p class="subtle">Defaults for quizzes and interactions (coming soon).</p>

            <div class="row" aria-disabled="true">
              <div class="label">
                <span class="title">Auto-advance</span>
                <span class="desc">Automatically go to the next question after answering.</span>
              </div>
              <span aria-hidden="true" title="Coming soon">⏳</span>
            </div>
          </section>
          ...
          <section class="card" aria-labelledby="about-title">
            ...
            <div class="row">
              <div class="label">
                ...
                <span class="desc">A fast, elegant quiz app built with Qwik + Vite.</span>
              </div>
              <span aria-hidden="true">✨</span>
            </div>
          </section>
